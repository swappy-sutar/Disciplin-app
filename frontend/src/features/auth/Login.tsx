              ...
              <>
                ...
                <div className="w-full flex justify-center items-center select-none">
                  <motion.div 
                    ...
                    className="w-[240px] h-[40px] relative flex items-center justify-center bg-[#f2f2f2] hover:bg-[#e8e8e8] rounded-full shadow-sm border border-[#e0e0e0]/60 transition-all cursor-pointer overflow-hidden"
                  >
                    {/* Visual Custom Google Button */}
                    <div className="flex items-center gap-3 font-semibold text-gray-700 select-none">
                    ...
                    <div className="absolute inset-0 opacity-0 cursor-pointer">
                      <div id="googleSignInButton" className="w-[240px] h-[40px] opacity-0 cursor-pointer" />
                    </div>
                  </motion.div>
                </div>
